...
class EventStore(typing.Generic[PersistentDomainEventT], metaclass=ABCMeta):
    class Queries(dict):
    ...
    async def _save(
        self,
        session: ISession,
        agg: IDomainEventAccessor[PersistentDomainEventT],
    ...
    def _do_make_event_query(self, event: PersistentDomainEventT) -> IEventInsertQuery:
