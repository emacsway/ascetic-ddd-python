...
class Attr2ValueGenerator:
    ...
    async def __call__(self, session: ISession, query=None, position: int = -1):
        val = "attr2_%s" % self._count
        self._count += 1
        return val


async def uuid_generator(session: ISession, query=None, position: int = -1):
    return uuid.uuid4()
...
class FirstModelFaker(AggregateProvider[dict, FirstModel, FirstModelPk, FirstModelPk]):
    ...
    def __init__(self, repository: IAggregateRepository[FirstModel], make_distributor):
        # ID is auto-generated by server - use DummyDistributor without input_generator
...
class SecondModelPkFaker(CompositeValueProvider[dict, SecondModelPk]):
    ...
    def __init__(
        ...
        # ID is auto-generated by DB - use DummyDistributor without input_generator
        self.id = ValueProvider(distributor=DummyDistributor())
        super().__init__(
            distributor=make_distributor(),
